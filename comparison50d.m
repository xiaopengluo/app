...
F = [.9 .95 1 1.05];
XTrace1 = de(fun,d,Kde,[20 F(1) 0.06]);
XTrace2 = de(fun,d,Kde,[20 F(2) 0.06]);
XTrace3 = de(fun,d,Kde,[20 F(3) 0.06]);
XTrace4 = de(fun,d,Kde,[20 F(4) 0.06]);
...
plot(20*(1:Kde),log10(sum(XTrace5.^2,2)),'k:')
xlim([0 15e4])
ylim([-12 8])
yticks([-12 -8 -4 0 4 8])
hold on
