...
Kde = 15000; para = [20 0.95 0.03];

XTrace0 = de(fun,d,Kde,para);

% various scale factors (F)
F = [.9 .95 1 1.05];
XTrace1 = de(fun,d,Kde,[20 F(1) 0.03]);
XTrace2 = de(fun,d,Kde,[20 F(2) 0.03]);
XTrace3 = de(fun,d,Kde,[20 F(3) 0.03]);
XTrace4 = de(fun,d,Kde,[20 F(4) 0.03]);
